...
export  const MovieDetail=()=> {
  ...
  useEffect(()=>
  {
    ...
    {
      const res=await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=f5c6e5963847c8175bc714e2cdd689f5`);
  ...
  return (
    ...
    <section className="flex justify-around flex-wrap py-5">
      ...
      <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
        ...
        <p className="my-4 lg:text-left">{data.overview}</p>
          { data.genres ? (
            <p className="my-7 flex flex-wrap gap-2 md:justify-center sm:justify-center ">
